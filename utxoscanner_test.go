...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*bchutil.Block
...
func NewMockChainClient() *MockChainClient {
	return &MockChainClient{
		getBlockResponse:     make(map[chainhash.Hash]*bchutil.Block),
		getBlockHashResponse: make(map[int64]*chainhash.Hash),
		getCFilterResponse:   make(map[chainhash.Hash]*gcs.Filter),
	}
}

func (c *MockChainClient) SetBlock(hash *chainhash.Hash, block *bchutil.Block) {
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block100000Hash, bchutil.NewBlock(&Block100000))
...
func TestUtxoScannerScanAddBlocks(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, bchutil.NewBlock(&Block99999))
...
// The following is taken from the gcash/bchutil project.
